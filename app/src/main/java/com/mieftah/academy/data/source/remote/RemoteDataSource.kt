...
class RemoteDataSource private constructor(private val jsonHelper: JsonHelper) {
    ...
    fun getAllCourses(): LiveData<ApiResponse<List<CourseResponse>>> { //: List<CourseResponse> = jsonHelper.loadCourses()
...
//                callback.onAllCoursesReceived(jsonHelper.loadCourses())
    ...
    fun getModules(courseId: String) : LiveData<ApiResponse<List<ModuleResponse>>> {// : List<ModuleResponse> = jsonHelper.loadModule(courseId)
        EspressoIdlingResource.increment()
    ...
    fun getContent(moduleId: String): LiveData<ApiResponse<ContentResponse>> {//: ContentResponse = jsonHelper.loadContent(moduleId)
        EspressoIdlingResource.increment()
